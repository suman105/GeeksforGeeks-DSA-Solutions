<h2><a href="https://practice.geeksforgeeks.org/problems/stack-using-two-queues/1?page=4&difficulty[]=0&status[]=solved&sortBy=submissions">Stack using two queues</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Implement a Stack&nbsp;using two queues<strong>&nbsp;q1</strong>&nbsp;and<strong>&nbsp;q2</strong>.</span></p>
