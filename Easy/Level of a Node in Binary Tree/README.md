<h2><a href="https://practice.geeksforgeeks.org/problems/level-of-a-node-in-binary-tree/1?page=10&difficulty[]=0&status[]=solved&sortBy=submissions">Level of a Node in Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:20px">Given a Binary Tree and a target key you need to find the level of target key in the given Binary Tree.</span></p>
