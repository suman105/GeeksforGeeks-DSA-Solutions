<h2><a href="https://practice.geeksforgeeks.org/problems/vertical-sum/1?page=9&difficulty[]=0&status[]=solved&sortBy=submissions">Vertical sum</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Binary Tree, find vertical sum of the nodes that are in same vertical line. Print all sums through different vertical lines starting from left-most vertical line to right-most vertical line.</span></p>
