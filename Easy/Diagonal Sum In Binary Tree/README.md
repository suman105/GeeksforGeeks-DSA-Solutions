<h2><a href="https://practice.geeksforgeeks.org/problems/diagonal-sum-in-binary-tree/1?page=10&difficulty[]=0&status[]=solved&sortBy=submissions">Diagonal Sum In Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Consider Red lines of slope -1 passing between nodes (in following&nbsp;diagram). The diagonal sum in a binary tree is the sum of all nodes data lying between these lines.&nbsp;Given a Binary Tree of size <strong>N</strong>, print all diagonal sums.</span></p>
