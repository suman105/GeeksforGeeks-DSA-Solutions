<h2><a href="https://practice.geeksforgeeks.org/problems/heap-sort/1?page=4&difficulty[]=1&status[]=solved&sortBy=submissions">Heap Sort</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of size N. The task is to sort the array elements by completing functions <strong>heapify</strong>() and <strong>buildHeap</strong>() which are used to implement Heap Sort.</span></p>
