<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-triplet-sum-in-array0129/1?page=4&difficulty[]=-1&status[]=solved&sortBy=submissions">Maximum triplet sum in array</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array, the task is to find the maximum triplet sum in the array.</span></p>
